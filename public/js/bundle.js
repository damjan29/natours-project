...
exports.logut = exports.login = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              alert('Logged in succesfully!'); // window.setTimeout(() => {
              // location.assign('/');
              // }, 1500)
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              alert("".concat(type.toUpperCase(), " updated successfuly"));
            }
...
var stripe = Stripe('pk_test_51Hlb84IcSMNuHbUHl0CR78GI0qPglQg2Ol9h0tZVxddCx6DvQcROZcMlMWiEVwE72HzuKyydrYykfDZEvveWCxwI00qABLET1R');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log("HELLO WORLD!!!" + session); // 2) Create checkout form + charge credit card
