...
exports.login = catchAsync(async (req, res, next) => {
    ...
    const user = await User.findOne({ email }).select('+password'); //eksplicitno selektujemo password jer smo je u modelu sakrili
    ...
    // 3) If evrythng ok, send token to client
...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    req.user = currentUser; // request object travles from middleware to middleware
    res.locals.user = currentUser;
    next();
});


// Only for rendered pagse, no errors
...
exports.restrictTo = (...roles) => {
    return (req, res, next) => {
        // roles is an array ['admin', 'lead-guy']
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    // const message = `Forgot your passwrod? Submit your PATCH request with your new password
